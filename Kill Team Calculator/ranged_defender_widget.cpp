...
void ranged_defender_widget::setup_ui(Ui_KillTeamCalculatorClass* ui)
{
	...
	defRerollNormalSuccessesCheckBox = ui->defRerollNormalSuccessesCheckBox;
	defRerollNormalSuccessesLabel = ui->defRerollNormalSuccessesLabel;
}
...
bool ranged_defender_widget::is_reroll_aggressively() const { return defRerollNormalSuccessesCheckBox->isChecked(); }
...
void ranged_defender_widget::set_reroll_aggressively(bool value) { defRerollNormalSuccessesCheckBox->setChecked(value); }
